                    ...
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <p style="margin:0 0 16px 0; font-size:14px; line-height:1.6; color:#3a3a3a;">
                                ...
                                {{ optional($demande->date_demande)->format('d/m/Y') }}
                                avec le Dr {{ $demande->consultation->medecin->user->name ?? '' }}, veuillez
                                trouver ci-joint votre <strong>demande d'examens complémentaires</strong> au
                                format PDF.
                            </p>
                            <p style="margin:0 0 20px 0; font-size:14px; line-height:1.6; color:#3a3a3a;">
                                Merci de la présenter au laboratoire ou au service concerné.
                            </p>
                            ...
                            <div style="background-color:#f7faf7; border:1px solid #d7e8da; border-radius:8px; padding:14px 16px; font-size:13px; color:#153a26;">
                                🧪 Demande n° {{ str_pad($demande->id, 6, '0', STR_PAD_LEFT) }} — {{ $demande->typesExamens->count() }} examen(s) prescrit(s)
                            </div>
                        </td>
                    </tr>
